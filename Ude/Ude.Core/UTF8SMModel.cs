namespace Ude.Core
{
    ...
    public class UTF8SMModel : SMModel
    {
        ...
        private static readonly int[] UTF8CharLenTable = new int[] { 0, 1, 0, 0, 0, 0, 2, 3, 3, 3, 4, 4, 5, 5, 6, 6 };

        public UTF8SMModel(): base( new BitPackage( BitPackage.INDEX_SHIFT_4BITS, 
